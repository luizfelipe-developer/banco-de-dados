...
$inserirSql = "INSERT INTO matricula_aluno(cod_aluno, nome, sobrenome, endereco, CPF, telefone, genero, cod_professor) 
VALUES ('$cod_aluno', '$nome', '$sobrenome', '$endereco', '$CPF', '$telefone', '$genero' , '$cod_professor')";
